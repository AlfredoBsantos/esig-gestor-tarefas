    ...
    public JPAUtil() {
        try {
            ...
            if (databaseUrl != null && !databaseUrl.isEmpty()) {
                ...
                // CORREÇÃO: Montamos a URL JDBC sem usar dbUri.getPort()
            ...
            // Se a variável de ambiente não existir, o JPA usará o persistence.xml (ambiente local)
            // Se existir, usará as propriedades que definimos acima.
